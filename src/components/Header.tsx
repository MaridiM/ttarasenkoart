    ...
    return (
        <header style={{ 
            ...
            <nav className={burger ? 'active' : ''}>
                ...
                <div><Link to={paths.home}>Home</Link></div>
                <div><Link to={paths.gallery}>Gallery</Link></div>
                <div><Link to={paths.cv}>CV</Link></div>
                <div><Link to={paths.texts}>Texts</Link></div>
                <div><Link to={paths.contact}>Contact Me</Link></div>
            </nav>
        </header>
    )
}
